...
export default function CaseStudyEditor({ study }: CaseStudyEditorProps): ReactElement {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <div className="flex flex-wrap gap-2">{study.status === 'published' ? <Button asChild type="button" variant="outline" className="rounded-none"><a href={`/studio/work/${study.slug}`} target="_blank" rel="noreferrer"><ExternalLink />View live</a></Button> : null}<Button type="button" variant="outline" onClick={() => void saveStudy()} disabled={saving} className="rounded-none"><Save />Save</Button><Button type="button" onClick={() => void saveStudy('published')} disabled={saving} className="rounded-none">{saving ? 'Saving...' : 'Publish'}</Button></div>
    </div>
    <Tabs defaultValue={defaultTab}>
      <TabsList className="h-auto w-full flex-wrap justify-start gap-0 rounded-none border-b border-border bg-transparent p-0"><TabsTrigger value="overview" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">Overview</TabsTrigger><TabsTrigger value="media" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">Media</TabsTrigger><TabsTrigger value="metadata" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">Metadata</TabsTrigger><TabsTrigger value="story" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">Story</TabsTrigger><TabsTrigger value="credits" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">Credits</TabsTrigger><TabsTrigger value="seo" className="rounded-none border-b-2 border-transparent bg-transparent px-4 pb-2 pt-1 shadow-none data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none">SEO</TabsTrigger></TabsList>
