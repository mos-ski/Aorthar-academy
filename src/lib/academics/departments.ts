...
const CODE_PREFIX_TO_DEPT: Record<string, string> = {
  ...
  QA: 'QA Engineering',
  SO: 'Agile Delivery & Operations',
  SCR: 'Agile Delivery & Operations',
  OPS: 'Agile Delivery & Operations',
  STR: 'Agile Delivery & Operations',
  PSY: 'Agile Delivery & Operations',
  BUS: 'Agile Delivery & Operations',
  LDR: 'Agile Delivery & Operations',
  ANA: 'Data & Analytics',
  DA: 'Data & Analytics',
