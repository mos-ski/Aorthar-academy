...
BEGIN
  ...
  -- ── UIP108 UI Design Principles ───────────────────────────────────────
  cid := md5('aorthar-course-UIP108')::uuid;
  INSERT INTO courses (id, code, name, description, year_id, semester_id, credit_units, is_premium, status) VALUES
    (cid, 'UIP108', 'UI Design Principles',
  ...
  INSERT INTO lessons (id, course_id, title, sort_order, is_published) VALUES
    (md5('aorthar-l-UIP108-1')::uuid, cid, 'Foundations of UI Design', 1, true),
    (md5('aorthar-l-UIP108-2')::uuid, cid, 'Navigation Patterns and Flows', 2, true),
    (md5('aorthar-l-UIP108-3')::uuid, cid, 'Buttons, Forms and Input Components', 3, true),
    (md5('aorthar-l-UIP108-4')::uuid, cid, 'Affordance and Signifiers', 4, true),
    (md5('aorthar-l-UIP108-5')::uuid, cid, 'Feedback, Error States and Empty States', 5, true),
    (md5('aorthar-l-UIP108-6')::uuid, cid, 'UI Patterns and Anti-Patterns', 6, true),
    (md5('aorthar-l-UIP108-7')::uuid, cid, 'Mobile UI Design Considerations', 7, true),
    (md5('aorthar-l-UIP108-8')::uuid, cid, 'Building Consistent UI Systems', 8, true)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-1')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-1-1')::uuid, lid, 'youtube', 'UI Design Fundamentals', 'https://www.youtube.com/watch?v=v6n1i0qojws', 1),
    (md5('aorthar-r-UIP108-1-2')::uuid, lid, 'youtube', 'UI Design Principles Overview', 'https://www.youtube.com/watch?v=mk1JL3Whlg8', 2),
    (md5('aorthar-r-UIP108-1-3')::uuid, lid, 'youtube', 'Introduction to Interface Design', 'https://www.youtube.com/watch?v=jk1T0CdLxwU', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-2')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-2-1')::uuid, lid, 'youtube', 'Navigation Design Patterns', 'https://www.youtube.com/watch?v=v6n1i0qojws', 1),
    (md5('aorthar-r-UIP108-2-2')::uuid, lid, 'youtube', 'Mobile Navigation Patterns', 'https://www.youtube.com/watch?v=jk1T0CdLxwU', 2),
    (md5('aorthar-r-UIP108-2-3')::uuid, lid, 'youtube', 'User Flow Design', 'https://www.youtube.com/watch?v=BjMbGdT3N2I', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-3')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-3-1')::uuid, lid, 'youtube', 'Designing Buttons and CTAs', 'https://www.youtube.com/watch?v=jk1T0CdLxwU', 1),
    (md5('aorthar-r-UIP108-3-2')::uuid, lid, 'youtube', 'Form Design Best Practices', 'https://www.youtube.com/watch?v=v6n1i0qojws', 2),
    (md5('aorthar-r-UIP108-3-3')::uuid, lid, 'youtube', 'Input Design Patterns', 'https://www.youtube.com/watch?v=FTFaQWZBqQ8', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-4')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-4-1')::uuid, lid, 'youtube', 'Affordance in Design', 'https://www.youtube.com/watch?v=mk1JL3Whlg8', 1),
    (md5('aorthar-r-UIP108-4-2')::uuid, lid, 'youtube', 'Signifiers and Perceived Affordance', 'https://www.youtube.com/watch?v=v6n1i0qojws', 2),
    (md5('aorthar-r-UIP108-4-3')::uuid, lid, 'youtube', 'Don Norman Design Principles', 'https://www.youtube.com/watch?v=_r0VX-aU_T8', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-5')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-5-1')::uuid, lid, 'youtube', 'Designing Error States', 'https://www.youtube.com/watch?v=v6n1i0qojws', 1),
    (md5('aorthar-r-UIP108-5-2')::uuid, lid, 'youtube', 'Empty States in UI Design', 'https://www.youtube.com/watch?v=jk1T0CdLxwU', 2),
    (md5('aorthar-r-UIP108-5-3')::uuid, lid, 'youtube', 'Micro Feedback in UI', 'https://www.youtube.com/watch?v=AzQXH0HmU7I', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-6')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-6-1')::uuid, lid, 'youtube', 'UI Design Patterns Library', 'https://www.youtube.com/watch?v=v6n1i0qojws', 1),
    (md5('aorthar-r-UIP108-6-2')::uuid, lid, 'youtube', 'UI Anti-Patterns to Avoid', 'https://www.youtube.com/watch?v=mk1JL3Whlg8', 2),
    (md5('aorthar-r-UIP108-6-3')::uuid, lid, 'youtube', 'Dark Patterns in UI Design', 'https://www.youtube.com/watch?v=7_sFVYfatXY', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-7')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-7-1')::uuid, lid, 'youtube', 'Mobile UI Design Guide', 'https://www.youtube.com/watch?v=jk1T0CdLxwU', 1),
    (md5('aorthar-r-UIP108-7-2')::uuid, lid, 'youtube', 'Touch Target Sizes', 'https://www.youtube.com/watch?v=3f31oufqFSM', 2),
    (md5('aorthar-r-UIP108-7-3')::uuid, lid, 'youtube', 'iOS vs Android Design Guidelines', 'https://www.youtube.com/watch?v=v6n1i0qojws', 3)
  ON CONFLICT (id) DO NOTHING;

  lid := md5('aorthar-l-UIP108-8')::uuid;
  INSERT INTO resources (id, lesson_id, type, title, url, sort_order) VALUES
    (md5('aorthar-r-UIP108-8-1')::uuid, lid, 'youtube', 'Building a Design System', 'https://www.youtube.com/watch?v=3h7-NkpNKLY', 1),
    (md5('aorthar-r-UIP108-8-2')::uuid, lid, 'youtube', 'Component-Based UI Design', 'https://www.youtube.com/watch?v=FTFaQWZBqQ8', 2),
    (md5('aorthar-r-UIP108-8-3')::uuid, lid, 'youtube', 'Design Tokens Explained', 'https://www.youtube.com/watch?v=3h7-NkpNKLY', 3)
  ON CONFLICT (id) DO NOTHING;

  INSERT INTO questions (id, course_id, type, question_text, options, points, shuffle_options, is_exam_question, difficulty) VALUES
    (md5('aorthar-q-UIP108-01')::uuid, cid, 'multiple_choice', 'Affordance in UI design refers to:',
    ...
    (md5('aorthar-q-UIP108-02')::uuid, cid, 'multiple_choice', 'Which of the following is an example of a destructive action that needs extra confirmation?',
    ...
    (md5('aorthar-q-UIP108-03')::uuid, cid, 'multiple_choice', 'A "CTA" in UI design stands for:',
    ...
    (md5('aorthar-q-UIP108-04')::uuid, cid, 'multiple_choice', 'The minimum recommended touch target size for mobile buttons according to Google Material Design is:',
    ...
    (md5('aorthar-q-UIP108-05')::uuid, cid, 'multiple_choice', 'An "empty state" in UI design refers to:',
    ...
    (md5('aorthar-q-UIP108-06')::uuid, cid, 'multiple_choice', 'A "dark pattern" in UI design is:',
    ...
    (md5('aorthar-q-UIP108-07')::uuid, cid, 'multiple_choice', 'Consistency in UI design is important because:',
    ...
    (md5('aorthar-q-UIP108-08')::uuid, cid, 'multiple_choice', 'Which navigation pattern is most common for mobile apps with 3–5 primary sections?',
    ...
    (md5('aorthar-q-UIP108-09')::uuid, cid, 'multiple_choice', 'What is the primary purpose of inline validation in form design?',
    ...
    (md5('aorthar-q-UIP108-10')::uuid, cid, 'multiple_choice', 'Design tokens are:',
    ...
    (md5('aorthar-q-UIP108-11')::uuid, cid, 'multiple_choice', 'Progressive disclosure in UI means:',
    ...
    (md5('aorthar-q-UIP108-12')::uuid, cid, 'multiple_choice', 'The "Fitts''s Law" in UI design states that:',
    ...
    (md5('aorthar-q-UIP108-13')::uuid, cid, 'multiple_choice', 'What does a breadcrumb navigation component show?',
    ...
    (md5('aorthar-q-UIP108-14')::uuid, cid, 'multiple_choice', 'When should a designer use a modal dialog?',
    ...
    (md5('aorthar-q-UIP108-15')::uuid, cid, 'multiple_choice', 'The "hamburger menu" icon (☰) is a:',
    ...
    (md5('aorthar-q-UIP108-16')::uuid, cid, 'multiple_choice', 'Which state of a button indicates it cannot be clicked?',
    ...
    (md5('aorthar-q-UIP108-17')::uuid, cid, 'multiple_choice', 'Skeleton screens are used in UI to:',
    ...
    (md5('aorthar-q-UIP108-18')::uuid, cid, 'multiple_choice', 'Which principle suggests that fewer choices lead to faster, easier decisions?',
    ...
    (md5('aorthar-q-UIP108-19')::uuid, cid, 'multiple_choice', 'What is the purpose of a "focus state" on interactive elements?',
    ...
    (md5('aorthar-q-UIP108-20')::uuid, cid, 'multiple_choice', 'A component-based design system benefits teams because:',
